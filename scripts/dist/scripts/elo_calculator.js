...
// @ts-ignore
const commander_elos_js_1 = require("../data/commander_elos.js");
// @ts-ignore
const thug_elos_js_1 = require("../data/thug_elos.js");
readElos(commander_elos_js_1.elos, 'commander');
readElos(thug_elos_js_1.elos, 'thug');
...
const { credential } = firebase_admin_1.default;
